        ...
        <div class="card card-primary col-md-12">
            <div class="card-header row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="card-title pull-left m-auto">Product List</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-header">
                <form method="get" action="{{ route('search-campaign-required-product-list',['campaign_name'=>$campaign_name]) }}" class="row">
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('add-or-remove-from-campaign',['store_p_id'=>$item->store_p_id,'type'=>1,'campaign_name'=>$campaign_name]) }}" class="d-block  p-1 btn btn-outline-danger btn-sm">ADD</a>
                                        </td>
