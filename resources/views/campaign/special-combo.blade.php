        ...
        <div class="card card-primary col-md-12">
            <div class="card-header row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-md-8">
                            <h4 class="card-title pull-left m-auto">Special Combo Offer</h4>
                        </div>
                        <div class="col-md-4">
                            <div class="card-title pull-right m-auto">
                                <a href="{{ route('campaign-req-product-list',['campaign_name'=>'Special Combo Offer']) }}" class="btn btn-info radius-30 btn btn-block">Add Product</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-header">
                <form method="get" action="{{ route('search-special-combo-offer') }}" class="row">
