            ...
            <div class="card card-primary col-md-12">
                <div class="card-header row">
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title pull-left m-auto">Shop Product List</h4>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-header">
                    ...
                    <form method="get" action="{{ route('search-shop-live-product') }}" class="row">
                                    ...
                                    @if (isset($data[0]))
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ env('store_admin_url') . 'images/products/' . $item->product_id . '-1.jpg' }}"
                                                ...
                                                <td>
                                                    <a href="#"
                                                        class="border-bottom p-1 d-block btn btn-outline-danger btn-sm mb-1"
                                                        data-toggle="modal"
                                                        data-target="#updateStockModal{{ $item->store_p_id }}">Update
                                                        Stock</a>

                                                    <a href="{{ route('enlist-store-proudct', ['store_p_id' => $item->store_p_id, 'enlist' => 0]) }}"
                                                        class="d-block  p-1 btn btn-outline-danger btn-sm">Remove</a>
                                                </td>

                                                {{-- start stock update modal --}}
                                                <div class="modal fade" id="updateStockModal{{ $item->store_p_id }}"
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content radius-30">
                                                            ...
                                                            <form method="post"
                                                                action="{{ route('store-stock-update') }}">

                                                                <input type="hidden" name="_token"
                                                                    value="{{ csrf_token() }}">
                                                                <input type="hidden" name="store_p_id"
                                                                    value="{{ $item->store_p_id }}">
                                                                ...
                                                                <div class="modal-body pb-5 pl-5 pr-5">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <button type="submit"
                                                                            class="btn btn-info radius-30 btn-lg btn-block">Update</button>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
